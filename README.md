...
For a full list of validated component versions, see the [Support Matrix](docs/support-matrix.md).

1. An OpenShift Container Platform 4.20, 4.21 or 4.22 cluster with:
